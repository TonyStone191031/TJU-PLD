...
set_property PACKAGE_PIN U8 [get_ports {secset}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {secset}]
#Bank = 34, Pin name = IO_L23P_T3_34,						Sch name = SW2
set_property PACKAGE_PIN R7 [get_ports {minset}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {minset}]
#Bank = 34, Pin name = IO_L19P_T3_34,						Sch name = SW3
set_property PACKAGE_PIN R6 [get_ports {hourset}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {hourset}]
...
set_property PACKAGE_PIN U4 [get_ports {timenum[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {timenum[0]}]
#Bank = 34, Pin name = IO_L9N_T1_DQS_34,					Sch name = SW9
set_property PACKAGE_PIN V2 [get_ports {timenum[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {timenum[1]}]
#Bank = 34, Pin name = IO_L9P_T1_DQS_34,					Sch name = SW10
set_property PACKAGE_PIN U2 [get_ports {timenum[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {timenum[2]}]
#Bank = 34, Pin name = IO_L11N_T1_MRCC_34,					Sch name = SW11
set_property PACKAGE_PIN T3 [get_ports {timenum[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {timenum[3]}]
#Bank = 34, Pin name = IO_L17N_T2_34,						Sch name = SW12
set_property PACKAGE_PIN T1 [get_ports {timenum[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {timenum[4]}]
#Bank = 34, Pin name = IO_L11P_T1_SRCC_34,					Sch name = SW13
set_property PACKAGE_PIN R3 [get_ports {timenum[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {timenum[5]}]
#Bank = 34, Pin name = IO_L14N_T2_SRCC_34,					Sch name = SW14
set_property PACKAGE_PIN P3 [get_ports {state_input[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {state_input[0]}]
#Bank = 34, Pin name = IO_L14P_T2_SRCC_34,					Sch name = SW15
set_property PACKAGE_PIN P4 [get_ports {state_input[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {state_input[1]}]
